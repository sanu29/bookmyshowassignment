...
export const Home = () =>{
    ...
    return(<>
                ...
                <img src={TrendingMovie[indexOfSlider].HeroImage}  width={"100%"} />
        ...
        {(allMovieData.data).filter((item,index)=>index>5 && index <10).map((item)=>{
            return(
              ...
              <Box bgColor={'#ffffff'} className={"trending"} height={"18rem"} width={"15rem"}  margin={"1rem"} boxShadow={"lg"} border={"1px"} borderColor={"gray.200"}
